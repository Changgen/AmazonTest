...
namespace AutomationTest.Generic.Configuration
{
    /// <summary>
    /// Represents the known and supported Platforms that test case runs on.
    /// </summary>
    ...
    public class OS
    {
        ...
        public OS(PlatformType typeValue)
        {
        ...
        internal static OS FromString(string platformName)
        {
            ...
            return new OS(platformTypeFromString);
        }
